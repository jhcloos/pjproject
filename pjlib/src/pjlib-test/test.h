...
#define INCLUDE_ERRNO_TEST          0	// GROUP_LIBC
...
#define INCLUDE_POOL_PERF_TEST	    0	// (PJ_HAS_MALLOC && GROUP_LIBC)
#define INCLUDE_STRING_TEST	    0	// GROUP_DATA_STRUCTURE
...
#define INCLUDE_SOCK_TEST	    0 	// GROUP_NETWORK
#define INCLUDE_SOCK_PERF_TEST      0	// GROUP_NETWORK
#define INCLUDE_SELECT_TEST	    0	// GROUP_NETWORK
